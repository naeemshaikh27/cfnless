...
> Integration tests are not required to pass in CI (they require Docker services). Run them locally before submitting changes to deploy, remove, or any AWS client wrapper.
...
- Plain CommonJS (`require`/`module.exports`) — no TypeScript in this package
